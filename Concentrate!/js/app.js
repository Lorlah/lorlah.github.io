...
const modalMoves = document.querySelector('.modal-moves').innerHTML;
const modalStars = document.querySelector('.modal-stars');
const modalClose = document.querySelector('.modal-close');
const timerValue = document.querySelector('.timer').innerHTML;
const restart = document.querySelector('.restart');
let startedTimer = true;
let minutes = 0, seconds = 0, timeCount; 
...
function displayStats() {
        modalTime.innerHTML = `Your Time: ${timerValue}`;
        modalMoves.innerHTML = `Total Moves: ${moveNo}`;
        modalStars.innerHTML = `Stars Collected: ${stars}`;
